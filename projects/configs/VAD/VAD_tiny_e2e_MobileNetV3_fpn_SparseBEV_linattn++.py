...
model = dict(
    ...
    # pretrained=dict(img='torchvision://mobilenet_v3_large'),
    img_backbone=dict(
        ...
        init_cfg=dict(  
            type='Pretrained',  
            checkpoint='/data/yuanhui/OmniDrive/VAD/ckpts/mobilenet_v3_large-3ea3c186.pth',  
            prefix='backbone.'),  # 
    ), 
    img_neck=dict(
        type='FPN',
    ...
    pts_bbox_head=dict(
        ...
        loss_plan_agent_dis=dict(type='PlanCollisionLoss', loss_weight=0.0),
        loss_plan_map_theta=dict(type='PlanMapDirectionLoss', loss_weight=0.0, lane_div_cls_idx=0),  # fake idx
