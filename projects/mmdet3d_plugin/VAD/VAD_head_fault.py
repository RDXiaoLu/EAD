...
class RNNModule(nn.Module):  
    ...
    def forward(self, x):  
        ...
        x = x.permute(1, 2, 0, 3).reshape(B, 300, -1)  # Shape: (B, 300, N*256)
...
class VADHead(DETRHead):
    ...
    def __init__(self,
        ...
        #加入循环神经网络RNN
        self.rnn_module = RNNModule(input_dim=3*self.embed_dims, output_dim=self.embed_dims)
    ...
    def forward(self,
        ...
        if len(his_feat) == 3:
            ...
            combined_his_feat = self.rnn_module(his_feat)  # 输出为 [B, A, D]
